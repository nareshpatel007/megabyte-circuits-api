...
class RegisterService
{
    ...
    public function register($userdata = [])
    {
        ...
        try {
            ...
            // Create a wallet transaction for the signup bonus
            ...
            // Log activity with signup details
            DB::table('activity_logs')->insert([
                'user_id' => $user_id,
                'action' => 'register',
                'module' => 'Authentication',
                'log_data' => json_encode(['description' => 'New user registered and received 20 FREE credits.']),
            ...
            DB::table('email_queue')->insert([
                'to' => $email,
                'subject' => 'Verify Your Email Address - Connectly360',
