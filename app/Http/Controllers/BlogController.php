...
class BlogController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $blog->update([
            ...
            'meta_keywords'       => $request->input('meta_keywords', $blog->meta_keywords),
            'canonical_url'       => $request->input('canonical_url', $blog->canonical_url),
            'og_title'            => $request->input('og_title', $blog->og_title),
            'og_description'      => $request->input('og_description', $blog->og_description),
            'og_image'            => $request->input('og_image', $blog->og_image),
            'twitter_title'       => $request->input('twitter_title', $blog->twitter_title),
            'twitter_description' => $request->input('twitter_description', $blog->twitter_description),
            'twitter_image'       => $request->input('twitter_image', $blog->twitter_image),
            ...
            'schema_markup'       => $request->input('schema_markup', $blog->schema_markup),
        ]);
